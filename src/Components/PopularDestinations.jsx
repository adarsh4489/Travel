                ...
                >
                  <div className="overflow-hidden rounded-t-xl">
                    <img
                      src={trip.image}
                      alt={trip.placeName}
                      className="w-full h-48 md:h-56 object-cover transition-transform duration-500 ease-in-out hover:scale-110"
                    />
                  </div>
                  <div className="p-5">
                    ...
                    <p className="text-sm md:text-base text-orange-500 font-bold mt-3">
                      From ₹{trip.price}
                    </p>
